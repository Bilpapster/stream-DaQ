...
#
# 2. Vibration Stability (vibration_stability):
#    - Uses custom function to check if vibration remains stable
#    - Trend slope should be close to zero (±0.1)
#
# 3. Speed Variation Detection (speed_variation):
#    - Identifies strong changes in speed (|slope| > 0.5)
#    - Helps detect mechanical issues
#
# Trend analysis complements traditional min-max and range checks for comprehensive
# data quality monitoring. While threshold checks validate current values, trend
# analysis ensures data consistency over time by detecting unexpected patterns
# or gradual shifts that could indicate sensor drift or measurement errors.
#
# Luckily, Stream DaQ offers a suite of over 30 data quality measures, including 
# range conformance, profiling statistics, trend analysis and many more - making 
# comprehensive data quality monitoring both powerful and effortless!
