...
data = data.windowby(
    ...
    min_len=daq.get_min_length_reducer('languages'),
    max_len=daq.get_max_length_reducer('languages'),
    mean_len=daq.get_mean_length_reducer('languages'),
    median_len=daq.get_median_length_reducer('languages'),
    # min_int_part_len=daq.get_min_integer_part_length_reducer('duration_watched'),
    # max_int_part_len=daq.get_max_integer_part_length_reducer('duration_watched'),
    # mean_int_part_len=daq.get_mean_integer_part_length_reducer('duration_watched'),
    # median_int_part_len=daq.get_median_integer_part_length_reducer('duration_watched'),
    # min_frac_part_len=daq.get_min_fractional_part_length_reducer('duration_watched'),
    # max_frac_part_len=daq.get_max_fractional_part_length_reducer('duration_watched'),
    # mean_frac_part_len=daq.get_mean_fractional_part_length_reducer('duration_watched'),
    # median_frac_part_len=daq.get_median_fractional_part_length_reducer('duration_watched'),
    # all_same=daq.get_all_values_same_reducer('interaction_events'),
    # asc=daq.get_ordering_check_reducer('date_and_time','interaction_events', TIME_FORMAT, "ASC"),
    # asc_eq=daq.get_ordering_check_reducer('date_and_time','interaction_events', TIME_FORMAT, "ASC_EQ"),
    # desc=daq.get_ordering_check_reducer('date_and_time','interaction_events', TIME_FORMAT, "DESC"),
    # desc_eq=daq.get_ordering_check_reducer('date_and_time','interaction_events', TIME_FORMAT, "DESC_EQ"),
    ...
    # sorted_by_time=daq.get_sorted_by_time_reducer('date_and_time','interaction_events', TIME_FORMAT),
    ...
    # most_freq_range_conformance=daq.get_number_of_most_frequent_range_conformance_reducer('interaction_events', 3, 6, True),
    # range_conformance_frac=daq.get_fraction_of_range_conformance_reducer('interaction_events', 3, 6, True),
    # most_freq_range_conformance_frac=daq.get_fraction_of_most_frequent_range_conformance_reducer('interaction_events', 3, 6, True),
    ...
    # pearson=daq.get_pearson_correlation_reducer('interaction_events', 'duration_watched'), # todo add a guard for the case the window has only one value, because pearsonr goes crazy
)
